...
- **You must activate the plugin to see all tabulators in plugin configuration.** But don`t worry! Since Verion `2021.08.14` there is a "sleep mode": The activated plugin does nothing, even if it is already configured through.
