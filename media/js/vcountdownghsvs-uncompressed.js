        ...
        update: function () {
            ...
            if (remaining > 10) {
                this.removeClass(target.nextElementSibling, 'warn');
						...
						var display = '<span class=chars-typed>' + this.charsTypedLabel + '' + currentCount + '</span>';
						display += '<span class=chars-remain>' + this.charsRemainLabel + '' + remaining + '</span>';
						display += '<span class=chars-max>' + this.charsMaxLabel + '' + this.maxChars + '</span>';
